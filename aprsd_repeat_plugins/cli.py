#!/usr/bin/env python3
"""
CLI tool for aprsd-repeat-plugins configuration export.
"""
...
def export_config_cmd(format='json'):
    ...
    try:
        from aprsd_repeat_plugins.conf.opts import export_config
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Export aprsd-repeat-plugins configuration options',
    )
    parser.add_argument(
        '--format',
        choices=['dict', 'json'],
